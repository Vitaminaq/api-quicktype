...
// /api/user/user/account/cancellation.delete
declare namespace Api.User.User.Account.Cancellation {
    export interface APIContent {
        params: { [key: string]: any };
        /**
         * OK
...
// /api/user/user/account/cancellation/check.get
declare namespace Api.User.User.Account.Cancellation.Check {
    export interface APIContent {
        params: { [key: string]: any };
        /**
         * OK
